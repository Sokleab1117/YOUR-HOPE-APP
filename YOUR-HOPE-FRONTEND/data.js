...
const T = {
  eng: {
    ...
    btnBack:'← Back', btnNext:'Next →', btnSeeResults:'See results →',
    alertAnswerAll:'Please answer all questions on this page.',
    alertDoTestFirst:'Please complete the DASS-21 test first.',
    // Results
    ...
    filterAllTypes:'All types', filterHospital:'Hospital', filterClinic:'Clinic', filterNGO:'NGO', filterService:'Service',
    nssfAll:'NSSF: All', nssfYes:'NSSF: Yes', nssfNo:'NSSF: No',
    mapLegendClinic:'Clinic', mapLegendHospital:'Hospital', mapLegendNGO:'NGO', mapLegendService:'Service',
    ...
    chatPlaceholder:'Type your question…', chatSendBtn:'Send',
    ...
    thinkingMsg:'Thinking…', aiErrorMsg:'AI feature requires internet connection. Please try again.',
    // Nav
    navHome:'Home', navTest:'DASS-21', navServices:'Services', navQuotes:'Quotes', navChat:'AI Support', navAdmin:'Admin',
    // Quotes tab
    ...
    aboutStartBtn:'📋 Start DASS-21 Test', aboutFindBtn:'📍 Find Mental Health Services',
    ...
    aboutPromise1:'Private and secure support', aboutPromise2:'Trusted mental health screening',
    aboutPromise3:'Easy access to clinics', aboutPromise4:'Encouraging and judgment-free guidance',
    ...
    // Auth pages — sign in
    siTitle:'Welcome Back', siSubtitle:'Sign in to your account',
    signinBtn:'Sign In', noAccount:"Don't have an account?", toggleSignup:'Sign Up',
    labelEmail:'Email Address', phEmail:'your@email.com',
    labelPassword:'Password', phPassword:'Enter your password',
    rememberMe:'Remember me',
    // Auth pages — sign up
    suTitle:'Create Account', suSubtitle:'Start your mental health journey',
    signupBtn:'Sign Up', alreadyAccount:'Already have an account?', toggleLogin:'Sign In',
    continueGuest:'← Continue browsing',
    labelName:'Full Name', phName:'John Doe',
    labelJob:'Job / Occupation', phJob:'Student, Teacher, Developer...', optionalLabel:'Optional',
    labelAge:'Age', phAge:'18',
    labelGender:'Gender',
    genderBlank:'Prefer not to say', genderFemale:'Female', genderMale:'Male', genderOther:'Other', genderPrefer:'Prefer not to say',
    labelConfirm:'Confirm Password', phConfirm:'Confirm your password',
    phPasswordNew:'At least 6 characters',
    termsText:'I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>',
    // Auth validation errors
    errFillAll:'Please fill in all fields', errValidEmail:'Please enter a valid email',
    errPassMin:'Password must be at least 6 characters', errPassMatch:'Passwords do not match',
    errTerms:'Please agree to Terms of Service', errJobLen:'Job must be 120 characters or less',
    errAge:'Age must be a whole number between 1 and 120', errGender:'Please choose a valid gender option',
    errNoServer:'Cannot connect to backend. Is the server running?',
    // Auth success messages
    successCreated:'Account created! Logging in...', successLogin:'Login successful!',
    // Sign out modal
    logoutBtn:'Sign Out', signoutTitle:'Sign Out',
    signoutMsg:'Are you sure you want to sign out?',
    cancelBtn:'Cancel', signoutConfirm:'Sign Out',
    // Auth prompt modal
    ...
    authPromptChatMsg:'Please sign up to chat with our AI support assistant.',
    authPromptSignin:'Sign In', authPromptSignup:'Create Account',
    // Admin
    adminEye:'Admin Control Center', adminTitle:'YOUR HOPE Dashboard',
    adminSub:'Manage users, screening results, clinics, and quotes from one clean workspace.',
    adminRefresh:'↻ Refresh', adminLoading:'Loading admin dashboard…',
    adminStatUsers:'Total Users', adminStatTests:'Total Tests', adminStatRisk:'High Risk', adminStatClinics:'Clinics',
    adminTabOverview:'Overview', adminTabUsers:'Users', adminTabResults:'Results', adminTabClinics:'Clinics', adminTabQuotes:'Quotes',
    adminRiskTitle:'Risk Level Breakdown', adminAvgTitle:'Average Scores', adminRecentTitle:'Recent Screening Results',
    adminThUser:'User', adminThD:'D', adminThA:'A', adminThS:'S', adminThWorst:'Worst', adminThDate:'Date',
    adminThProfile:'Profile', adminThRole:'Role', adminThStatus:'Status', adminThJoined:'Joined',
    adminThScores:'Scores', adminThLevels:'Levels',
    adminSearchUsers:'Search users by name, email, or job…', adminSearchResults:'Search result by user or email…',
    adminAllRoles:'All roles', adminRoleUser:'user', adminRoleAdmin:'admin',
    adminAllLevels:'All levels',
    adminAddClinicTitle:'Add Clinic / Service', adminClinicDirTitle:'Clinic Directory Preview',
    adminPhClinicName:'Clinic name', adminPhLocation:'Location / District', adminPhPhone:'Phone number',
    adminBtnAddClinic:'Add Clinic', adminBtnSearch:'Search', adminBtnDelete:'Delete',
    adminAddQuoteTitle:'Add Motivational Quote', adminLatestQuotesTitle:'Latest Quotes',
    adminPhQuote:'Write a quote…', adminPhCategory:'Category', adminBtnAddQuote:'Add Quote',
    adminLangEng:'English', adminLangKh:'Khmer',
    adminNssfNo:'NSSF: No', adminNssfYes:'NSSF: Yes',
    adminAvgDep:'Depression', adminAvgAnx:'Anxiety', adminAvgStr:'Stress',
    adminAgeYrs:'yrs', adminAgeNone:'Age —', adminGenderNone:'Gender —',
    adminNoLocation:'No location',
    adminDashReady:'Dashboard ready. Data loaded from backend.',
    adminDashFail:'Could not load admin dashboard.',
    adminUserUpdated:'User updated successfully.',
    adminClinicAdded:'Clinic added successfully.', adminClinicDeleted:'Clinic deleted.',
    adminQuoteAdded:'Quote added successfully.', adminQuoteDeleted:'Quote deleted.',
    adminDeleteConfirm:'Delete this item?',
    adminNoRisk:'No results yet.',
    adminNoResultsRecent:'No screening results yet.',
    adminNoUsers:'No users found.', adminNoResults:'No results found.',
    adminNoClinics:'No clinics in database yet.', adminNoQuotes:'No quotes yet.',
    // Print
    pmMeta:'DASS-21 Screening Results', pScore:'Score', pLevel:'Level', pDep:'Depression', pAnx:'Anxiety', pStr:'Stress',
  },
  kh: {
    // Brand
    brandName:'YOUR HOPE', brandTag:'សុខភាពផ្លូវចិត្ត ភ្នំពេញ',
    // Home hero
    ...
    hc5l:'ពាក្យ', hc5t:'ការលើកទឹកចិត្តប្រចាំថ្ងៃ', hc5d:'ស្វែងរកពាក្យ សម្រាប់សង្ឃឹម ភាពរឹងមាំ និងស្ងប់ស្ងាត់។', hc5b:'មើលពាក្យ →',
    hDisc:'កម្មវិធីនេះសម្រាប់ជាព័ត៌មានប៉ុណ្ណោះ។ DASS-21 ជាឧបករណ៍ស្ទង់មតិ មិនមែនការធ្វើរោគវិនិច្ឆ័យ។ ប្រសិនបើអ្នកស្ថិតក្នុងស្ថានភាពអាសន្ន សូមទំនាក់ទំនងអ្នកជំនាញ។',
    // DASS-21 test
    tEye:'ការស្ទង់មតិសុខភាពផ្លូវចិត្ត', tTitle:'ការវាយតម្លៃ DASS-21', tSub:'២១ ចំណុចដែលវាស់ស្ទង់ការធ្លាក់ទឹកចិត្ត ការថប់បារម្ភ និងភាពតានតឹង ~៥ នាទី។',
    ...
    btnBack:'← ត្រឡប់', btnNext:'បន្ទាប់ →', btnSeeResults:'មើលលទ្ធផល →',
    alertAnswerAll:'សូមឆ្លើយសំណួរទាំងអស់នៅទំព័រនេះ។',
    alertDoTestFirst:'សូមបំពេញតេស្ត DASS-21 មុន។',
    // Results
    ...
    // Services
    sEye:'ភ្នំពេញ', sTitle:'សេវាកម្មសុខភាពផ្លូវចិត្ត', sSub:'ចម្រាញ់ និងស្វែងរកសេវាកម្មសុខភាពផ្លូវចិត្តនៅភ្នំពេញ។',
    svList:'បញ្ជី', svMap:'ផែនទី',
    filterAllTypes:'ប្រភេទទាំងអស់', filterHospital:'មន្ទីរពេទ្យ', filterClinic:'គ្លីនិក', filterNGO:'អង្គការ NGO', filterService:'សេវាកម្ម',
    nssfAll:'NSSF: ទាំងអស់', nssfYes:'NSSF: មាន', nssfNo:'NSSF: គ្មាន',
    mapLegendClinic:'គ្លីនិក', mapLegendHospital:'មន្ទីរពេទ្យ', mapLegendNGO:'អង្គការ NGO', mapLegendService:'សេវាកម្ម',
    ...
    recNormal:'លទ្ធផលរបស់អ្នកស្ថិតក្នុងជួរធម្មតា។ NGO សេវាសុខុមាលភាព និងការប្រឹក្សាជាជម្រើស។',
    // Chat
    cEye:'ប្រើ Claude AI', cTitle:'ការគាំទ្រ AI', cSub:'សួរអំពីសុខភាពផ្លូវចិត្ត លទ្ធផល ឬការស្វែងរកគ្លីនិក។',
    cDisc:'ចម្លើយ AI សម្រាប់ព័ត៌មានទូទៅ។ ត្រូវតែពិគ្រោះជាមួយអ្នកជំនាញ។',
    chatPlaceholder:'វាយសំណួររបស់អ្នក…', chatSendBtn:'ផ្ញើ',
    ...
    thinkingMsg:'កំពុងគិត…', aiErrorMsg:'មុខងារ AI ត្រូវការអ៊ីនធឺណិត។ សូមព្យាយាមម្ដងទៀត។',
    // Nav
    navHome:'ផ្ទះ', navTest:'DASS-21', navServices:'សេវាកម្ម', navQuotes:'ពាក្យ', navChat:'AI', navAdmin:'អ្នកគ្រប់គ្រង',
    // Quotes tab
    qEye:'ការលើកទឹកចិត្តប្រចាំថ្ងៃ', qTitle:'ពាក្យនៃសង្ឃឹម', qSub:'ចំណាយពេលដើម្បីស្វែងរកការលើកទឹកចិត្តប្រចាំថ្ងៃ',
    // Scales & levels
    ...
    // About
    aEye:'អំពីយើង', aTitle:'YOUR <span>HOPE</span>', aSub:'កន្លែងសុវត្ថិភាពសម្រាប់ការគាំទ្រសុខភាពផ្លូវចិត្ត',
    aboutHeroTitle:'កន្លែងសុវត្ថិភាពសម្រាប់ការគាំទ្រសុខភាពផ្លូវចិត្ត។',
    aboutHeroLead:'ជួយមនុស្សឱ្យយល់ពីអារម្មណ៍ ស្វែងរកការគាំទ្រ និងចាប់ផ្តើមជំហានទៅកាន់សុខភាពផ្លូវចិត្ត។',
    aboutStartBtn:'📋 ចាប់ផ្តើមតេស្ត DASS-21', aboutFindBtn:'📍 ស្វែងរកសេវាសុខភាពផ្លូវចិត្ត',
    aMissionTitle:'បេសកកម្មរបស់យើង', aMissionText:'ធ្វើឱ្យការគាំទ្រសុខភាពផ្លូវចិត្តងាយស្រួល ឯកជន និងអាចចូលប្រើបាន។',
    aVisionTitle:'ចក្ខុវិស័យរបស់យើង', aVisionText:'សហគមន៍ដែលសុខភាពផ្លូវចិត្តត្រូវបានយល់ ទទួលយក និងគាំទ្រ។',
    aValuesTitle:'ការសន្យារបស់យើង',
    aboutPromise1:'ការគាំទ្រឯកជន និងមានសុវត្ថិភាព', aboutPromise2:'ការស្ទង់មតិដែលអាចទុកចិត្ត',
    aboutPromise3:'ងាយស្រួលស្វែងរកគ្លីនិក', aboutPromise4:'ការណែនាំ ដោយគ្មានការវិនិច្ឆ័យ',
    aboutWhyTitle:'ហេតុអ្វីជ្រើសរើស YOUR HOPE?',
    aboutFeature1Title:'តេស្ត DASS-21 ឥតគិតថ្លៃ', aboutFeature1Desc:'វាយតម្លៃធ្លាក់ទឹកចិត្ត ការថប់បារម្ភ និងភាពតានតឹងបានលឿន។',
    aboutFeature2Title:'គាំទ្រភាសាខ្មែរ និងអង់គ្លេស', aboutFeature2Desc:'ប្រើកម្មវិធីជាភាសាដែលអ្នកចូលចិត្ត។',
    aboutFeature3Title:'លទ្ធផលភ្លាមៗ', aboutFeature3Desc:'ទទួលបានលទ្ធផលភ្លាមៗ និងយល់អារម្មណ៍កាន់តែច្បាស់។',
    aboutFeature4Title:'ការគាំទ្រអារម្មណ៍ដោយ AI', aboutFeature4Desc:'ជជែកជាមួយជំនួយការ AI នៅពេលណាដែលអ្នកត្រូវការ។',
    aboutFeature5Title:'បញ្ជីគ្លីនិកនៅភ្នំពេញ', aboutFeature5Desc:'ស្វែងរកសេវាសុខភាពផ្លូវចិត្តដែលអាចទុកចិត្ត។',
    aboutFeature6Title:'ពាក្យលើកទឹកចិត្ត', aboutFeature6Desc:'ការបំផុសគំនិតប្រចាំថ្ងៃ ដើម្បីរក្សាអ្នកឱ្យវិជ្ជមាន។',
    aboutClosingQuote:'\u201cអ្នកមិននៅម្នាក់ឯងទេ។ ជំហានតូចៗអាចនាំទៅកាន់សុខភាពផ្លូវចិត្ត។\u201d',
    av1Name:'ភាពឯកជនមុន', av1Desc:'ទិន្នន័យរបស់អ្នកគឺពិសិដ្ឋ។ យើងមិនរក្សាទុក ឬចែករំលែកព័ត៌មានផ្ទាល់ខ្លួន។',
    av2Name:'ផ្អែកលើភស្តុតាង', av2Desc:'យើងប្រើឧបករណ៍ស្ទង់មតិដូចជា DASS-21 ដែលទុកចិត្តដោយអ្នកជំនាញ។',
    av3Name:'ផ្តោតលើសហគមន៍', av3Desc:'យើងសហការជាមួយគ្លីនិក និងសេវាកម្មក្នុងស្រុក ដើម្បីគាំទ្រអ្នក។',
    // Auth pages — sign in
    siTitle:'សូមស្វាគមន៍ត្រឡប់មកវិញ', siSubtitle:'ចូលក្នុងគណនីរបស់អ្នក',
    signinBtn:'ចូលក្នុង', noAccount:'មិនទាន់មានគណនី?', toggleSignup:'ចុះឈ្មោះ',
    labelEmail:'អ៊ីម៉ែល', phEmail:'your@email.com',
    labelPassword:'ពាក្យសម្ងាត់', phPassword:'បញ្ចូលពាក្យសម្ងាត់',
    rememberMe:'ចងចាំខ្ញុំ',
    // Auth pages — sign up
    suTitle:'បង្កើតគណនី', suSubtitle:'ចាប់ផ្តើមដំណើរសុខភាពផ្លូវចិត្ត',
    signupBtn:'ចុះឈ្មោះ', alreadyAccount:'មានគណនីរួចហើយ?', toggleLogin:'ចូលក្នុង',
    continueGuest:'← បន្តមើល',
    labelName:'ឈ្មោះពេញ', phName:'ឈ្មោះ នាមត្រកូល',
    labelJob:'មុខរបរ', phJob:'សិស្ស, គ្រូ, អ្នកអភិវឌ្ឍន៍...', optionalLabel:'មិនចាំបាច់',
    labelAge:'អាយុ', phAge:'18',
    labelGender:'ភេទ',
    genderBlank:'មិនចង់បញ្ជាក់', genderFemale:'ស្ត្រី', genderMale:'បុរស', genderOther:'ផ្សេងទៀត', genderPrefer:'មិនចង់បញ្ជាក់',
    labelConfirm:'បញ្ជាក់ពាក្យសម្ងាត់', phConfirm:'បញ្ជាក់ពាក្យសម្ងាត់',
    phPasswordNew:'យ៉ាងតិច ៦ តួអក្សរ',
    termsText:'ខ្ញុំយល់ព្រមនឹង <a href="#">លក្ខខណ្ឌប្រើប្រាស់</a> និង <a href="#">គោលការណ៍ឯកជនភាព</a>',
    // Auth validation errors
    errFillAll:'សូមបំពេញព័ត៌មានទាំងអស់', errValidEmail:'សូមបញ្ចូលអ៊ីម៉ែលត្រឹមត្រូវ',
    errPassMin:'ពាក្យសម្ងាត់ត្រូវមានយ៉ាងតិច ៦ តួអក្សរ', errPassMatch:'ពាក្យសម្ងាត់មិនដូចគ្នា',
    errTerms:'សូមយល់ព្រមលក្ខខណ្ឌ', errJobLen:'មុខរបរមិនអាចលើស ១២០ តួ',
    errAge:'អាយុត្រូវជាលេខគត់ ១–១២០', errGender:'សូមជ្រើសភេទត្រឹមត្រូវ',
    errNoServer:'មិនអាចភ្ជាប់ backend។ តើ server កំពុងដំណើរការ?',
    // Auth success messages
    successCreated:'បានបង្កើតគណនី! កំពុងចូល...', successLogin:'ចូលបានជោគជ័យ!',
    // Sign out modal
    logoutBtn:'ចាកចេញ', signoutTitle:'ចាកចេញ',
    signoutMsg:'តើអ្នកប្រាកដថាចង់ចាកចេញ?',
    cancelBtn:'បោះបង់', signoutConfirm:'ចាកចេញ',
    // Auth prompt modal
    authPromptTitle:'តម្រូវឱ្យចុះឈ្មោះ',
    authPromptTestMsg:'សូមចុះឈ្មោះ ដើម្បីចូលប្រើការវាយតម្លៃ DASS-21 និងរក្សាទុកលទ្ធផល។',
    authPromptServicesMsg:'សូមចុះឈ្មោះ ដើម្បីរកមើលសេវាកម្មសុខភាពផ្លូវចិត្ត និងទទួលការណែនាំ។',
    authPromptChatMsg:'សូមចុះឈ្មោះ ដើម្បីជជែកជាមួយជំនួយការ AI របស់យើង។',
    authPromptSignin:'ចូល', authPromptSignup:'បង្កើតគណនី',
    // Admin
    adminEye:'មជ្ឈមណ្ឌលគ្រប់គ្រង', adminTitle:'ផ្ទាំងគ្រប់គ្រង YOUR HOPE',
    adminSub:'គ្រប់គ្រងអ្នកប្រើ លទ្ធផលស្ទង់មតិ គ្លីនិក និងពាក្យ ពីកន្លែងតែមួយ។',
    adminRefresh:'↻ ធ្វើឱ្យស្រស់', adminLoading:'កំពុងផ្ទុកផ្ទាំងគ្រប់គ្រង…',
    adminStatUsers:'អ្នកប្រើប្រាស់សរុប', adminStatTests:'ការតេស្តសរុប', adminStatRisk:'ហានិភ័យខ្ពស់', adminStatClinics:'គ្លីនិក',
    adminTabOverview:'ទិដ្ឋភាពទូទៅ', adminTabUsers:'អ្នកប្រើ', adminTabResults:'លទ្ធផល', adminTabClinics:'គ្លីនិក', adminTabQuotes:'ពាក្យ',
    adminRiskTitle:'ការបែងចែកកម្រិតហានិភ័យ', adminAvgTitle:'ពិន្ទុមធ្យម', adminRecentTitle:'លទ្ធផលស្ទង់មតិថ្មីៗ',
    adminThUser:'អ្នកប្រើ', adminThD:'D', adminThA:'A', adminThS:'S', adminThWorst:'ធ្ងន់បំផុត', adminThDate:'កាលបរិច្ឆេទ',
    adminThProfile:'ប្រវត្តិរូប', adminThRole:'តួនាទី', adminThStatus:'ស្ថានភាព', adminThJoined:'ចូលរួម',
    adminThScores:'ពិន្ទុ', adminThLevels:'កម្រិត',
    adminSearchUsers:'ស្វែងរកអ្នកប្រើ…', adminSearchResults:'ស្វែងរកលទ្ធផល…',
    adminAllRoles:'តួនាទីទាំងអស់', adminRoleUser:'user', adminRoleAdmin:'admin',
    adminAllLevels:'កម្រិតទាំងអស់',
    adminAddClinicTitle:'បន្ថែមគ្លីនិក / សេវាកម្ម', adminClinicDirTitle:'បញ្ជីគ្លីនិក',
    adminPhClinicName:'ឈ្មោះគ្លីនិក', adminPhLocation:'ទីតាំង / ស្រុក', adminPhPhone:'លេខទូរស័ព្ទ',
    adminBtnAddClinic:'បន្ថែមគ្លីនិក', adminBtnSearch:'ស្វែងរក', adminBtnDelete:'លុប',
    adminAddQuoteTitle:'បន្ថែមពាក្យលើកទឹកចិត្ត', adminLatestQuotesTitle:'ពាក្យចុងក្រោយ',
    adminPhQuote:'សរសេរពាក្យ…', adminPhCategory:'ប្រភេទ', adminBtnAddQuote:'បន្ថែមពាក្យ',
    adminLangEng:'អង់គ្លេស', adminLangKh:'ខ្មែរ',
    adminNssfNo:'NSSF: គ្មាន', adminNssfYes:'NSSF: មាន',
    adminAvgDep:'ធ្លាក់ទឹកចិត្ត', adminAvgAnx:'ការថប់បារម្ភ', adminAvgStr:'ភាពតានតឹង',
    adminAgeYrs:'ឆ្នាំ', adminAgeNone:'អាយុ —', adminGenderNone:'ភេទ —',
    adminNoLocation:'គ្មានទីតាំង',
    adminDashReady:'ផ្ទាំងគ្រប់គ្រងរួចរាល់។', adminDashFail:'មិនអាចផ្ទុកបាន។',
    adminUserUpdated:'បានធ្វើបច្ចុប្បន្នភាពអ្នកប្រើ។',
    adminClinicAdded:'បន្ថែមគ្លីនិករួចរាល់។', adminClinicDeleted:'លុបគ្លីនិករួចរាល់។',
    adminQuoteAdded:'បន្ថែមពាក្យរួចរាល់។', adminQuoteDeleted:'លុបពាក្យរួចរាល់។',
    adminDeleteConfirm:'លុបធាតុនេះ?',
    adminNoRisk:'មិនទាន់មានលទ្ធផល។',
    adminNoResultsRecent:'មិនទាន់មានលទ្ធផលស្ទង់មតិ។',
    adminNoUsers:'រកមិនឃើញអ្នកប្រើ។', adminNoResults:'រកមិនឃើញលទ្ធផល។',
    adminNoClinics:'មិនទាន់មានគ្លីនិក។', adminNoQuotes:'មិនទាន់មានពាក្យ។',
    // Print
